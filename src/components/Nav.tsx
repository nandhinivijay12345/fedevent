  ...
  return (
    ...
    >
      ...
      <div className="mx-auto grid h-[72px] max-w-[1280px] grid-cols-[auto_1fr_auto] items-center gap-6 px-8">
        ...
        <Link
          to="/confirm"
          className="justify-self-end inline-flex items-center gap-2 rounded-full bg-[#D62828] px-5 py-2.5 text-[13px] font-medium tracking-wide text-white transition-all duration-300 hover:scale-[1.02] hover:bg-[#b71f1f] hover:shadow-[0_10px_30px_-12px_rgba(214,40,40,0.55)]"
        >
          Confirm Attendance
        </Link>
